...
// Count the numbers of digits d used in the writing of all the k**2. Call nb_dig (or nbDig or ...) the function taking n and d as 
...
function nbDig(n, d) {
  ...
  let arr2 = arr.join('').split('');
  return arr2.filter(item => item == d).length;
}